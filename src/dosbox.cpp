...
#include "mt32options.h"
	...
	const char* oplemus[]={ "default", "compat", "fast", "mame", "nuked", "opl2lpt", "opl3lpt", "opl2board", "opl3duoboard", 0};
	...
	Pint = secprop->Add_int("oplbaudrate",Property::Changeable::OnlyAtStart,115200);
	Pint->Set_help("Serial port baud rate of the OPL2/3 audio board only\n"
						"Examples: 115200(default), 213400, 400000, etc\n"
						"accepts non-standard rates if your hardware support its");
